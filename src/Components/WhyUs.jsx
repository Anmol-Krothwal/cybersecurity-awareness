            ...
            <div className="w-full grid grid-cols-4 gap-x-[1rem]">
                <div className="card_outerdiv boxShadow1">
                    <div className="max-h-[9.5rem]">
                        <img src={`/assets/Image/whyus_card1.jpeg`} alt="card" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="card_outerdiv boxShadow1">
                    <div className="max-h-[9.5rem]">
                        <img src={`/assets/Image/whyus_card2.jpeg`} alt="card" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="card_outerdiv boxShadow1">
                    <div className="max-h-[9.5rem]">
                        <img src={`/assets/Image/whyus_card3.jpeg`} alt="card" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="card_outerdiv boxShadow1">
                    <div className="max-h-[9.5rem]">
                        <img src={`/assets/Image/whyus_card4.jpeg`} alt="card" className="w-full h-full object-cover" />
                    </div>
