...
// Use Vite var if set, otherwise default to your Node server
...
const Contactus = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      // send to backend (keep existing UX)
      try {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      {/* 🔷 Only Heading Section Dark */}
      <div className="pt-20 pb-4 px-6 md:px-16 lg:px-32 bg-gradient-to-b from-[#0b0c2a] to-[#1c1f3a] text-white text-center ">
        <h1 className="text-5xl font-extrabold text-purple-300 drop-shadow-md">
          📞 Contact Us
        </h1>
        <p className="text-lg mt-2 text-white">We'd love to hear from you! 💌</p>
      </div>

      {/* 🔶 Form and Office Block - Light Background */}
      <div className="px-6 md:px-16 lg:px-32 flex flex-col md:flex-row gap-10 py-12 bg-white">
        {/* Form */}
          ...
          {submitted && (
            <div className="mt-6 text-center">
              ...
              <div className="flex justify-center items-center mt-2 gap-3">
                <img
                  src="/assets/Image/mascot.png"  // place under /public/assets/Image/
                  alt="Mascot waving"
                  className="w-16 h-16"
                />
        ...
        <div className="w-full md:w-1/2">
          <div className="bg-white p-6 rounded-xl shadow-md mb-6 text-gray-800">
